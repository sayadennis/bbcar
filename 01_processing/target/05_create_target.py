...
label.to_csv(f'{dout}/bbcar_label_studyid_from_gatk_filenames.csv', header=True, index=True)
...
# REDCap mapping - obtained from https://redcap.nubic.northwestern.edu/redcap/redcap_v12.0.26/Design/data_dictionary_codebook.php?pid=3928
