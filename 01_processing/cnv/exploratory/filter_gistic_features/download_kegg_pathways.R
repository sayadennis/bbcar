...
# step2: check and obtain a list of entry identifiers (in this case: sar)
# and associated definition for a given database or a given set of database entries.
...
# step5: Parse and write the gene sets to a flat text file in GMT format
# for other pathway enrichment analysis programs (e.g., GSEA):
for (setname in cancer_list) {
  writeGMT(
    hg["setname"],
    gmt.file = paste0("/Users/sayadennis/Projects/bbcar_project/kegg_genesets/", setname)
  )
}
