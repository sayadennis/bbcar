...
germlines <- scan(
  "/projects/b1131/saya/bbcar/data/sample_ids_all_germline.txt",
  what = "", sep = "\n"
)
tissues <- scan(
  "/projects/b1131/saya/bbcar/data/sample_ids_all_tissue.txt",
  what = "", sep = "\n"
)
...
for (sampleid in sampleids) {
  if ((sampleid %in% germlines) && (sampleid %in% tissues)) {
