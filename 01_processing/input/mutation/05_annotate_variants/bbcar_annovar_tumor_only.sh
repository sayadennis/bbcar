...
#SBATCH --job-name=av_to_${SLURM_ARRAY_TASK_ID}
#SBATCH --output=bbcar/out/annovar_tumor_only_%a.out
...
dout='/projects/b1131/saya/bbcar/03_annotated_variants/annovar/tumor_only'
