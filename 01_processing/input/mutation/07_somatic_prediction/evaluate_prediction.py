...
## Data
din='/projects/b1042/lyglab/saya/bbcar/04_ml_features_tmp'
dout='/projects/b1042/lyglab/saya/bbcar/05_ml_eval_tmp'

X=pd.read_csv(f'{din}/input.csv', index_col=0)
y=pd.read_csv(f'{din}/target.csv', index_col=0)

meta=pd.read_csv(f'{din}/features_imputed.csv') # this contains meta information about each variant (variant exonic function etc.) 
...
somatic_rate.to_csv('somatic_rates_exonicfunc_refgene.csv')
