...
tissue_vcfs = glob.glob(f'{dn}/02_variant_calls/tumor_only/*_DPfiltered_{filter_type}AF_{pon_source}pon.vcf')
tissue_sample_ids = [
...
for sample_id in tissue_only_sample_ids:
    fin = f'{dn}/02_variant_calls/tumor_only/{sample_id}_DPfiltered_{filter_type}AF_{pon_source}pon.vcf'
