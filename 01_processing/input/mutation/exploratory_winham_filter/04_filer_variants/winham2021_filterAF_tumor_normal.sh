...
bcftools filter --include "FORMAT/AF>=0.05" --output-type v --output ${dout}/liberal/02_variant_calls/tumor_normal/${input_args[$SLURM_ARRAY_TASK_ID]}_DPfiltered_liberalAF_bbcarpon.vcf $din/${input_args[$SLURM_ARRAY_TASK_ID]}_DPfiltered_bbcarpon.vcf
...
bcftools filter --include "FORMAT/AF>=0.10" --output-type v --output ${dout}/strict/02_variant_calls/tumor_normal/${input_args[$SLURM_ARRAY_TASK_ID]}_DPfiltered_strictAF_bbcarpon.vcf $din/${input_args[$SLURM_ARRAY_TASK_ID]}_DPfiltered_bbcarpon.vcf
