...
## Pre-filter
with open(
    "/projects/b1131/saya/bbcar/02_variant_calls/tumor_only/varcounts_preDPfilter.txt",
    "r",
    encoding="utf-8",
) as f:
    lines = f.readlines()
...
## Post-filter
with open(
    "/projects/b1131/saya/bbcar/02_variant_calls/tumor_only/varcounts_postDPfilter.txt",
    "r",
    encoding="utf-8",
) as f:
    lines = f.readlines()
...
## Pre-filter
with open(
    "/projects/b1131/saya/bbcar/02_variant_calls/tumor_only/varcounts_preDPfilter_bbcarpon.txt",
    "r",
    encoding="utf-8",
) as f:
    lines = f.readlines()
...
## Post-filter
with open(
    "/projects/b1131/saya/bbcar/02_variant_calls/tumor_only/varcounts_postDPfilter_bbcarpon.txt",
    "r",
    encoding="utf-8",
) as f:
    lines = f.readlines()
...
## Pre-filter
with open(
    "/projects/b1131/saya/bbcar/02_variant_calls/germline_only/varcounts_preDPfilter.txt",
    "r",
    encoding="utf-8",
) as f:
    lines = f.readlines()
...
## Post-filter
with open(
    "/projects/b1131/saya/bbcar/02_variant_calls/germline_only/varcounts_postDPfilter.txt",
    "r",
    encoding="utf-8",
) as f:
    lines = f.readlines()
...
## Pre-filter
with open(
    "/projects/b1131/saya/bbcar/02_variant_calls/tumor_normal/varcounts_preDPfilter.txt",
    "r",
    encoding="utf-8",
) as f:
    lines = f.readlines()
...
## Post-filter
with open(
    "/projects/b1131/saya/bbcar/02_variant_calls/tumor_normal/varcounts_postDPfilter.txt",
    "r",
    encoding="utf-8",
) as f:
    lines = f.readlines()
...
## Pre-filter
with open(
    "/projects/b1131/saya/bbcar/02_variant_calls/tumor_normal/varcounts_preDPfilter_bbcarpon.txt",
    "r",
    encoding="utf-8",
) as f:
    lines = f.readlines()
...
## Post-filter
with open(
    "/projects/b1131/saya/bbcar/02_variant_calls/tumor_normal/varcounts_postDPfilter_bbcarpon.txt",
    "r",
    encoding="utf-8",
) as f:
    lines = f.readlines()
...
plt.violinplot(
    [pre_to, post_to, pre_go, post_go, pre_tn, post_tn],
    np.arange(6),
    showextrema=True,
    showmedians=True,
    bw_method="silverman",
...
plt.violinplot(
    [pre_to_bbpon, post_to_bbpon, pre_go, post_go, pre_tn_bbpon, post_tn_bbpon],
    np.arange(6),
    showextrema=True,
    showmedians=True,
    bw_method="silverman",
