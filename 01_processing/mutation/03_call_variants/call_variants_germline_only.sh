...
#SBATCH --output=/projects/b1131/saya/bbcar/out/call_variants_germline_haplotype_%a.out
...
IFS=$'\n' read -d '' -r -a uchicago < /projects/b1131/saya/bbcar/data/02a_mutation/sample_ids_uchicago.txt
