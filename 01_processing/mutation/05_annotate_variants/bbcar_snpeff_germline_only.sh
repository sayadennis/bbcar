...
#SBATCH --job-name="snpeff_go_\${SLURM_ARRAY_TASK_ID}"
#SBATCH --output=bbcar/out/snpeff_germline_only_%a.out
...
dout='/projects/b1131/saya/bbcar/03_annotated_variants/snpeff/germline_only'
