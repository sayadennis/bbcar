...
#SBATCH --output=~/bbcar_project/out/run_gistic2_conf90.out

basedir="/projects/b1122/saya/bbcar_project/gistic2_out_conf90"
...
./gistic2 -b $basedir -seg $segfile -refgene $refgenefile -genegistic 0 -smallmem 0 -brlen 0.98 -conf 0.90 -armpeel 0 -savegene 1 -gcm extreme
# -mk $intervals 
