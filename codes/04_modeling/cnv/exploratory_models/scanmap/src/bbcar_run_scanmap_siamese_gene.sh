...
#SBATCH --output=bbcar/out/bbcar_run_scanmap_siamese_gene.out
...
python bbcar/src/modeling/scanmap/src/bbcar_run_scanmap_siamese.py \
    --genomic $datadir/gene_thres_conf90_intindex_abs.csv \
    --confound $cfdir/bbcar_clin_intindex.csv \
    --label $labeldir/bbcar_label_intindex.csv \
    --outdir $train_record_dir/genethres_clin \
    --index $indexdir \
    --n_iter 4000 \
    > $resultsdir/results_siamese_genethres_clin.txt
#
...
python bbcar/src/modeling/scanmap/src/bbcar_run_scanmap_siamese.py \
    ...
    --label $labeldir/bbcar_label_intindex.csv \
    --outdir $train_record_dir/genethres_clin_mut \
    --index $indexdir \
    > $resultsdir/results_siamese_genethres_clin_mut.txt
#
...
python bbcar/src/modeling/scanmap/src/bbcar_run_scanmap_siamese.py \
    ...
    --label $labeldir/bbcar_label_intindex.csv \
    --outdir $train_record_dir/genethres_clin_prs \
    --index $indexdir \
    > $resultsdir/results_siamese_genethres_clin_prs.txt
#
...
python bbcar/src/modeling/scanmap/src/bbcar_run_scanmap_siamese.py \
    ...
    --label $labeldir/bbcar_label_intindex.csv \
    --outdir $train_record_dir/genethres_clin_driversomatic \
    --index $indexdir \
    --n_iter 4000 \
    > $resultsdir/results_siamese_genethres_clin_driversomatic.txt
#
...
python bbcar/src/modeling/scanmap/src/bbcar_run_scanmap_siamese.py \
    ...
    --label $labeldir/bbcar_label_intindex.csv \
    --outdir $train_record_dir/genethres_clin_mut_prs \
    --index $indexdir \
    > $resultsdir/results_siamese_genethres_clin_mut_prs.txt
#
...
python bbcar/src/modeling/scanmap/src/bbcar_run_scanmap_siamese.py \
    ...
    --label $labeldir/bbcar_label_intindex.csv \
    --outdir $train_record_dir/genethres_clin_mut_driversomatic \
    --index $indexdir \
    > $resultsdir/results_siamese_genethres_clin_mut_driversomatic.txt
#
...
python bbcar/src/modeling/scanmap/src/bbcar_run_scanmap_siamese.py \
    ...
    --label $labeldir/bbcar_label_intindex.csv \
    --outdir $train_record_dir/genethres_clin_prs_driversomatic \
    --index $indexdir \
    > $resultsdir/results_siamese_genethres_clin_prs_driversomatic.txt
#
