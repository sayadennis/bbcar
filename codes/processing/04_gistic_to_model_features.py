...
cnv_dict = generate_gistic_features(f'{d03}/all')

if not os.path.isdir(f'{d04}/all'):
    os.mkdir(f'{d04}/all')

cnv_dict['genecopy'].to_csv(f'{d04}/all/gene_copy_conf90_all.csv', header=True, index=True)
cnv_dict['genethres'].to_csv(f'{d04}/all/gene_thres_conf90_all.csv', header=True, index=True)
(cnv_dict['genecopy']+2).to_csv(f'{d04}/all/gene_copy_conf90_all_plus2.csv', header=True, index=True)
(cnv_dict['genethres']+2).to_csv(f'{d04}/all/gene_thres_conf90_all_plus2.csv', header=True, index=True)

cnv_dict['regcopy'].to_csv(f'{d04}/all/reg_copy_conf90_all.csv', header=True, index=True)
cnv_dict['regthres'].to_csv(f'{d04}/all/reg_thres_conf90_all.csv', header=True, index=True)
(cnv_dict['regcopy']+2).to_csv(f'{d04}/all/reg_copy_conf90_all_plus2.csv', header=True, index=True)

cnv_dict['cytocopy'].to_csv(f'{d04}/all/cyto_copy_conf90_all.csv', header=True, index=True)
cnv_dict['cytothres_amp'].to_csv(f'{d04}/all/cyto_thres_amp_conf90_all.csv', header=True, index=True)
cnv_dict['cytothres_del'].to_csv(f'{d04}/all/cyto_thres_del_conf90_all.csv', header=True, index=True)
(cnv_dict['cytocopy']+2).to_csv(f'{d04}/all/cyto_copy_conf90_all_plus2.csv', header=True, index=True)
...
cnv_case = generate_gistic_features(f'{d03}/all_cases')
cnv_cont = generate_gistic_features(f'{d03}/all_controls')

# stack the gene-level features together 
gene_copy = pd.concat((cnv_case['genecopy'], cnv_cont['genecopy']), axis=0).sort_index(axis=0)
gene_thres = pd.concat((cnv_case['genethres'], cnv_cont['genethres']), axis=0).sort_index(axis=0)

# stack the cytoband-level features together 
cyto_copy = pd.concat((cnv_case['cytocopy'], cnv_cont['cytocopy']), axis=0).fillna(0.).sort_index(axis=0)
cyto_thres_amp = pd.concat((cnv_case['cytothres_amp'], cnv_cont['cytothres_amp']), axis=0).fillna(0.).sort_index(axis=0)
cyto_thres_del = pd.concat((cnv_case['cytothres_del'], cnv_cont['cytothres_del']), axis=0).fillna(0.).sort_index(axis=0)
...
gene_thres.to_csv(f'{d04}/all_ccsep/gene_thres_conf90_ccsep.csv', header=True, index=True)
(gene_thres+2).to_csv(f'{d04}/all_ccsep/gene_thres_conf90_ccsep_plus2.csv', header=True, index=True)

cnv_case['regcopy'].to_csv(f'{d04}/all_ccsep/reg_copy_conf90_cases.csv', header=True, index=True)
cnv_cont['regcopy'].to_csv(f'{d04}/all_ccsep/reg_copy_conf90_controls.csv', header=True, index=True)
cnv_case['regthres'].to_csv(f'{d04}/all_ccsep/reg_thres_conf90_cases.csv', header=True, index=True)
cnv_cont['regthres'].to_csv(f'{d04}/all_ccsep/reg_thres_conf90_controls.csv', header=True, index=True)

cyto_copy.to_csv(f'{d04}/all_ccsep/cyto_copy_conf90_ccsep.csv', header=True, index=True)
cyto_thres_amp.to_csv(f'{d04}/all_ccsep/cyto_thres_amp_conf90_ccsep.csv', header=True, index=True)
cyto_thres_del.to_csv(f'{d04}/all_ccsep/cyto_thres_del_conf90_ccsep.csv', header=True, index=True)

#########################################################
#### Training cases and training controls separately ####
#########################################################

cnv_case = generate_gistic_features(f'{d03}/train_cases')
cnv_cont = generate_gistic_features(f'{d03}/train_controls')
...
## save all the feature matrices 
gene_copy.to_csv(f'{d04}/train_ccsep/gene_copy_conf90_ccsep.csv', header=True, index=True)
gene_thres.to_csv(f'{d04}/train_ccsep/gene_thres_conf90_ccsep.csv', header=True, index=True)
(gene_thres+2).to_csv(f'{d04}/train_ccsep/gene_thres_conf90_ccsep_plus2.csv', header=True, index=True)

cnv_case['regcopy'].to_csv(f'{d04}/train_ccsep/reg_copy_conf90_cases.csv', header=True, index=True)
cnv_cont['regcopy'].to_csv(f'{d04}/train_ccsep/reg_copy_conf90_controls.csv', header=True, index=True)
cnv_case['regthres'].to_csv(f'{d04}/train_ccsep/reg_thres_conf90_cases.csv', header=True, index=True)
cnv_cont['regthres'].to_csv(f'{d04}/train_ccsep/reg_thres_conf90_controls.csv', header=True, index=True)

cyto_copy.to_csv(f'{d04}/train_ccsep/cyto_copy_conf90_ccsep.csv', header=True, index=True)
cyto_thres_amp.to_csv(f'{d04}/train_ccsep/cyto_thres_amp_conf90_ccsep.csv', header=True, index=True)
cyto_thres_del.to_csv(f'{d04}/train_ccsep/cyto_thres_del_conf90_ccsep.csv', header=True, index=True)

###################################################################################
#### (Training cases + test all) and (training controls + test all) separately ####
###################################################################################

cnv_case = generate_gistic_features(f'{d03}/train_cases_test_all')
cnv_cont = generate_gistic_features(f'{d03}/train_controls_test_all')
...
## save all the feature matrices 
gene_copy.to_csv(f'{d04}/train_ccsep_test_all/gene_copy_conf90_ccsep.csv', header=True, index=True)
gene_thres.to_csv(f'{d04}/train_ccsep_test_all/gene_thres_conf90_ccsep.csv', header=True, index=True)
(gene_thres+2).to_csv(f'{d04}/train_ccsep_test_all/gene_thres_conf90_ccsep_plus2.csv', header=True, index=True)

cnv_case['regcopy'].to_csv(f'{d04}/train_ccsep_test_all/reg_copy_conf90_cases.csv', header=True, index=True)
cnv_cont['regcopy'].to_csv(f'{d04}/train_ccsep_test_all/reg_copy_conf90_controls.csv', header=True, index=True)
cnv_case['regthres'].to_csv(f'{d04}/train_ccsep_test_all/reg_thres_conf90_cases.csv', header=True, index=True)
cnv_cont['regthres'].to_csv(f'{d04}/train_ccsep_test_all/reg_thres_conf90_controls.csv', header=True, index=True)

cyto_copy.to_csv(f'{d04}/train_ccsep_test_all/cyto_copy_conf90_ccsep.csv', header=True, index=True)
cyto_thres_amp.to_csv(f'{d04}/train_ccsep_test_all/cyto_thres_amp_conf90_ccsep.csv', header=True, index=True)
cyto_thres_del.to_csv(f'{d04}/train_ccsep_test_all/cyto_thres_del_conf90_ccsep.csv', header=True, index=True)
...
##################################################################################################################
##################################################################################################################
######## Transform the test sets to generate the final model features with both training and testing data ########
##################################################################################################################
##################################################################################################################
...
test_studyid = list(pd.read_csv(f'{dix}/test_studyid.csv', header=None)[0]) # this is the study ID that matches the GATK file names
...
test_cytocopy = transform_gatk_to_reg_matrix(aber_cyto_regions, d01, sampleset=test_studyid)
...
test_genecopy = transform_gatk_to_reg_matrix(gene_regions, d01, sampleset=list(test_studyid))
...
cytocopy_transformed.sort_index(axis=0).to_csv(f'{d04}/train_ccsep_test_all/cyto_copy.csv', header=True, index=True)
...
genecopy_transformed.sort_index(axis=0).to_csv(f'{d04}/train_ccsep_test_all/gene_copy.csv', header=True, index=True)
