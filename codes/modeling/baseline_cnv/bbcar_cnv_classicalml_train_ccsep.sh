...
#SBATCH --job-name="bbcar_cnv_classicalml_train_ccsep"
#SBATCH --output=bbcar/out/bbcar_cnv_classicalml_train_ccsep.out

. ~/anaconda3/etc/profile.d/conda.sh
conda activate bbcarenv

inputdir='/projects/b1122/saya/04_cleaned_cnv/train_ccsep'
labeldir='/projects/b1122/saya'
outdir='/home/srd6051/bbcar/model_performance/results_classicalml/train_ccsep'
