...
cn_data = {
    "amp": pd.read_csv(
        "/projects/b1131/saya/new_bbcar/data/02b_cnv/10_cleaned_cnv/cyto_thres_amp.csv",
        index_col=0,
    ),
    "del": pd.read_csv(
        "/projects/b1131/saya/new_bbcar/data/02b_cnv/10_cleaned_cnv/cyto_thres_del.csv",
        index_col=0,
    ),
}
