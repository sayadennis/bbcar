...
performances = {
    ...
    "No fusion cnv": pd.read_csv(f"{din}/no_fusion_cnv_cytothres.csv", index_col=0),
    "Early fusion": pd.read_csv(f"{din}/early_fusion_cnv_cytothres.csv", index_col=0),
    "Late fusion": pd.read_csv(f"{din}/late_fusion_cnv_cytothres.csv", index_col=0),
