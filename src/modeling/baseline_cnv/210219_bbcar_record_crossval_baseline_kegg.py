...
gene_copy = pd.read_csv("/share/fsmresfiles/bbcar/genecopy_conf90_kegg.csv", header=0, index_col=0)
...
BBCarModelTraining.record_tuning(
    ...
    "/home/srd6051/bbcar_project/outputs/genecopy_conf90_crossval_record_kegg.csv"
)

# Gene-level threshold values
gene_thres = pd.read_csv("/share/fsmresfiles/bbcar/genethres_conf90_kegg.csv", header=0, index_col=0)
X_train, X_test, y_train, y_test = train_test_split(gene_thres, target, test_size=0.2, random_state=seed)
BBCarModelTraining.record_tuning(
    X_train, y_train, X_test, y_test, 
    "/home/srd6051/bbcar_project/outputs/genethres_conf90_crossval_record_kegg.csv"
)
